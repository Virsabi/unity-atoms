...
namespace UnityAtoms.BaseAtoms
{
        ...
        where VI : class, IVariable<V>
    {
        ...
        private void Start()
        {
            ...
            {
                _syncToCollection.GetValue().Add(String.IsNullOrWhiteSpace(_syncToCollectionKey.Value) ? GetInstanceID().ToString() : _syncToCollectionKey.Value, _variableInstancer.Variable);
            }
